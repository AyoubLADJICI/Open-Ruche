...
void loop() {
  static int cpt = 1; // Garde en mémoire le nombre de messages envoyés

  Serial.print("Envoi du message LoRa #");
  Serial.println(cpt);
  ...
  modem.print("Test ");
  modem.print(cpt);
  modem.print(" - Projet Open Ruche - Groupe B-Nahl");
  int err = modem.endPacket(true); // true = mode asynchrone
